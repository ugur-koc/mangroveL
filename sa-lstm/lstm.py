...
def lstm_layer(tparams, state_below, options, prefix='lstm', mask=None):
    ...
    rval, updates = theano.scan(_step, sequences=[mask, state_below], outputs_info=[tensor.alloc(numpy_floatX(0.), n_samples, dim_proj),
...
def train_lstm(
    ...
    maxlen=1000000,  # Sequence longer then this get ignored
