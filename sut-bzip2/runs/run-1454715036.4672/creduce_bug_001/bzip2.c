...
static void generateMTFValues(EState *s) {
  ...
  UInt16 *mtfv = s->mtfv
      ...
      ;
  generateMTFValues_EOB = s->nInUse + 1;

  generateMTFValues_i = 0;
  
  for (generateMTFValues_i; generateMTFValues_i <= generateMTFValues_EOB; generateMTFValues_i++)
    s->mtfFreq[generateMTFValues_i] = 0;

  generateMTFValues_wr = 0;
  generateMTFValues_zPend = 0;
  generateMTFValues_i = 0;
  
  for (generateMTFValues_i; generateMTFValues_i < s->nInUse; generateMTFValues_i++)
    yy[generateMTFValues_i] = generateMTFValues_i;

  generateMTFValues_i = 0;
  
  for (generateMTFValues_i; generateMTFValues_i < s->nblock; generateMTFValues_i++) {
    
    0;
    generateMTFValues_j = ptr[generateMTFValues_i] - 1;
    generateMTFValues_j < 0;

    generateMTFValues_j = s->nblock;
    generateMTFValues_ll_i = s->unseqToSeq[block[generateMTFValues_j]];
    0;
  ...
  s->mtfFreq[generateMTFValues_EOB]++;

  s->nMTF = generateMTFValues_wr;
}
