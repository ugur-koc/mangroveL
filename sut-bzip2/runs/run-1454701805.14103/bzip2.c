...
#define BZ_GET_FAST s > tPos = s > tt[s > tPos] cccc = s > tPos = 8

#define BZ_GET_FAST_C c_tPos = c_tt[c_tPos] cccc = c_tPos = 8
...
#define BZ_GET_SMALL cccc = BZ2_indexIntoF s > tPos = GET_LL
...
#define GET_BITS case lll s > state = lll if
...
static void *default_bzalloc,
    *BZ_APIBZ2_bzWrite_buf = 0, *BZ_APIBZ2_bzWrite_b = 0,
    *BZ_APIBZ2_bzReadClose_b = 0, *BZ_APIBZ2_bzRead_buf = 0,
    *BZ_APIBZ2_bzRead_b = 0, *BZ_APIBZ2_bzReadGetUnused_b = 0,
    *bzopen_or_bzdopen, *BZ_APIBZ2_bzread_b = 0, *BZ_APIBZ2_bzerror_b = 0;

static void default_bzfree(void);

Int32 BZ2_bzCompressInit_n;
int BZ_API(BZ2_bzCompressInit)(bz_stream *p1, int p2, int p3, int p4) {
...
int BZ_API(BZ2_bzDecompressInit)(bz_stream *p1, int p2, int p3) {
  DState *s;
...
int *BZ_APIBZ2_bzWrite_bzerror = 0, *BZ_APIBZ2_bzReadGetUnused_nUnused = 0,
    *BZ_APIBZ2_bzerror_errnum = 0;
Int32 BZ_APIBZ2_bzWrite_ret;
void BZ_APIBZ2_bzWrite(void) {

  bzFile *bzf = BZ_APIBZ2_bzWrite_b BZ_SETERR;

  bzf->strm.avail_in = BZ_APIBZ2_bzWrite_len;
  bzf->strm.next_in = BZ_APIBZ2_bzWrite_buf;
}

void BZ_API(BZ2_bzWriteClose)(int *p1, BZFILE *p2, int p3, unsigned int *p4,
                              unsigned int *p5) {
  BZ2_bzWriteClose64;
}
...
void BZ_APIBZ2_bzReadClose(void) {
  ...
  bzFile *bzf = BZ_APIBZ2_bzReadClose_b BZ_SETERR;
...
int BZ_APIBZ2_bzRead(void) {
  ...
  bzFile *bzf = BZ_APIBZ2_bzRead_b BZ_SETERR;
...
void BZ_APIBZ2_bzReadGetUnused(void) {
  ...
  BZ_SETERR *BZ_APIBZ2_bzReadGetUnused_nUnused = bzf->strm.avail_in;
...
unsigned int BZ_APIBZ2_bzBuffToBuffCompress_sourceLen = 0,
             BZ_APIBZ2_bzBuffToBuffDecompress_sourceLen = 0;
char *BZ_APIBZ2_bzBuffToBuffCompress_source = 0,
     *BZ_APIBZ2_bzBuffToBuffCompress_dest = 0,
     *BZ_APIBZ2_bzBuffToBuffDecompress_source = 0,
     *BZ_APIBZ2_bzBuffToBuffDecompress_dest = 0;
unsigned int *BZ_APIBZ2_bzBuffToBuffCompress_destLen = 0,
             *BZ_APIBZ2_bzBuffToBuffDecompress_destLen = 0;
...
int BZ_APIBZ2_bzread(void) {
  ...
  if (BZ_APIBZ2_bzread_bzerr == BZ_OK ||
      BZ_APIBZ2_bzread_bzerr == BZ_STREAM_END) {
