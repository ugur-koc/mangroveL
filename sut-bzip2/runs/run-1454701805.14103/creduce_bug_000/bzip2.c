...
bz_stream *BZ_APIBZ2_bzCompress_strm = 0;
...
bz_stream *BZ_APIBZ2_bzDecompress_strm = 0;
...
void *BZ_APIBZ2_bzWrite_buf = 0;
BZFILE *BZ_APIBZ2_bzWrite_b = 0;
int *BZ_APIBZ2_bzWrite_bzerror = 0;
...
BZFILE *BZ_APIBZ2_bzReadClose_b = 0;
...
void *BZ_APIBZ2_bzRead_buf = 0;
BZFILE *BZ_APIBZ2_bzRead_b = 0;
...
int *BZ_APIBZ2_bzReadGetUnused_nUnused = 0;
void **BZ_APIBZ2_bzReadGetUnused_unused = 0;
BZFILE *BZ_APIBZ2_bzReadGetUnused_b = 0;
...
char *BZ_APIBZ2_bzBuffToBuffCompress_dest = 0;
...
unsigned int BZ_APIBZ2_bzBuffToBuffDecompress_sourceLen = 0;
char *BZ_APIBZ2_bzBuffToBuffDecompress_source = 0;
unsigned int *BZ_APIBZ2_bzBuffToBuffDecompress_destLen = 0;
char *BZ_APIBZ2_bzBuffToBuffDecompress_dest = 0;
...
int *BZ_APIBZ2_bzerror_errnum = 0;
BZFILE *BZ_APIBZ2_bzerror_b = 0;
