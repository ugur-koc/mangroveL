 ...
 *BZ_APIBZ2_bzWriteOpen(int *bzerror, FILE *f, int blockSize100k,
 ...
 bzFile *BZ_APIBZ2_bzWrite_b_bzf = 0;
BZ_APIBZ2_bzWrite_b
 (
...
int *BZ_APIBZ2_bzBuffToBuffCompress_sourceLen_destLen;
char *BZ_APIBZ2_bzBuffToBuffCompress_sourceLen_dest;
...
errhandler:
 ...
 BZ_APIBZ2_bzBuffToBuffDecompress_ret;
  int BZ_APIBZ2_bzBuffToBuffDecompress_sourceLen_destLen;
char BZ_APIBZ2_bzBuffToBuffDecompress_sourceLen_dest;
